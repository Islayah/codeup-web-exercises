...
shoppers.forEach(function (shopper) {
    ...
    if (shopper.amount > 200) {
        ...
        console.log(shopper.name + ', your amount before discount is: $' + shopper.amount + ', your discount is: $' + discount + ', and your total after discount is: $' + amountAfterDiscount);
    } else {
...
console.log(createBook('test', 'test1 test2'));

// This adds a book to the books array
