...
// console.log(sayHello(name: "codeup")); -----> Bad code
...
/*
var totalBillInput = prompt("What is your toal bill?");
var tipAmountInput = prompt("What tip percentage?");

alert(calculateTip(tipAmountInput, totalBillInput));
*/
